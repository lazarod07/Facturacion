package co.cristian.springboot.app.view.pdf;
...
public class FacturaPdfView extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		cell = new PdfPCell(new Phrase(mensajes.getMessage("text.factura.datos.cliente")));
		...
		cell = new PdfPCell(new Phrase(mensajes.getMessage("text.factura.datos.factura")));
