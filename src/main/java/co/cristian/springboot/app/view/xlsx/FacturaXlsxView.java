package co.cristian.springboot.app.view.xlsx;
...
import co.cristian.springboot.app.models.entity.ItemFactura;
...
public class FacturaXlsxView extends AbstractXlsxView {
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		sheet.createRow(0).createCell(0).setCellValue(mensajes.getMessage("text.factura.datos.cliente"));
		...
		sheet.createRow(4).createCell(0).setCellValue(mensajes.getMessage("text.factura.datos.factura"));
